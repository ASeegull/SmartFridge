...
var SearchModalComponent = (function () {
    ...
    SearchModalComponent.prototype.search = function () {
        ...
        this.mainService.getRecipesByProduct(this.productName).subscribe(function (data) { _this.recipes = data; if (data.length === 0) {
...
var MainService = (function () {
    ...
    MainService.prototype.deleteAgent = function (id) {
        return this.http
            .delete(__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].apiURL + ("client/removeAgent/" + id), { observe: 'response', withCredentials: true });
    };
